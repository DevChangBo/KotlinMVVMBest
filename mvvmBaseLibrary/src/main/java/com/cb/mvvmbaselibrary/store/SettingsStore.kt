...
object SettingsStore {
    ...
    fun setWebTextZoom(textZoom: Int) =
        putSpValue(KEY_WEB_TEXT_ZOOM, textZoom)

    fun getWebTextZoom() =
        getSpValue( KEY_WEB_TEXT_ZOOM, DEFAULT_WEB_TEXT_ZOOM)

    fun setNightMode(nightMode: Boolean) =
        putSpValue(KEY_NIGHT_MODE, nightMode)

    fun getNightMode() =
        getSpValue(KEY_NIGHT_MODE, false)
}